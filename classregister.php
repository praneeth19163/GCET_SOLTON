...
if (isset($_POST["submit"])) {
    ...
    if ($stmt = $conn->prepare('INSERT INTO classproblems (name, id, blockno, floorno, roomno, description, time) VALUES (?, ?, ?, ?, ?, ?, ?)')) {
        ...
        $subject = "Class Problem Registered";
        $message = "A Class Problem has been registered by $name in Block $block, Floor $floor, Room $room. Description: $description";
        ...
        try {
            ...
            document.location.href='classregister.php';
            </script>";
        } catch (Exception $e) {
            echo "<script>
...
<body>
    ...
    <form action="classregister.php" method="post" id="form" onsubmit="return validateForm()">
        <div class="wrapper">
            ...
            <input type="text" name="room" id="room" placeholder="Enter Room No" class="input-field" required>
